...
import os
# GL_list=[]
# GL_list.append(globalconstants.FLAGS.picture1.copy())
# GL_list.append(globalconstants.FLAGS.picture2.copy())
# GL_list.append(globalconstants.FLAGS.picture3.copy())
# GL_list.append(globalconstants.FLAGS.picture4.copy())
# GL_list.append(globalconstants.FLAGS.picture5.copy())
# GL_list.append(globalconstants.FLAGS.picture6.copy())
# GL_list.append(globalconstants.FLAGS.picture7.copy())
# GL_list.append(globalconstants.FLAGS.picture8.copy())
# GL_list.append(globalconstants.FLAGS.picture9.copy())
# GL_list.append(globalconstants.FLAGS.picture10.copy())
...
#     sess.run(tf.globalconstants_variables_initializer())
#     sess.run(tf.local_variables_initializer())
#     #sess = tf_debug.LocalCLIDebugWrapperSession(sess)
#     for i in range(1):  # 进行训练
#         for j in range(1):
#             img_raw=tf.gfile.GFile(globalconstants.FLAGS.TrainPicturesPath+'cat'+str(i+1)+'.jpg','rb').read()
...
#         saver.save(sess,'tmp/FasterRcnn.ckpt',globalconstants_step=i)
